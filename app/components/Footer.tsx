      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10">
          ...
          <div className="max-w-xs">
            <div className="flex items-center gap-2.5 mb-3">
              ...
              <span className="font-bold text-white text-base">Shop by Credpay</span>
            </div>
            <p className="text-[#8A9BB0] text-sm leading-relaxed">
              Universal checkout infrastructure for humans and autonomous agents. Powered by x402.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-x-16 gap-y-6">
            ...
            <div>
              <p className="text-xs text-white/30 font-semibold uppercase tracking-widest mb-4">Company</p>
              <ul className="space-y-3">
                {[
        ...
        <div className="border-t border-white/10 mt-12 pt-8">
          <p className="text-xs text-[#8A9BB0]/60 text-center">
            © 2025 Credpay · Payments infrastructure for autonomous agents
          </p>
        </div>
      </div>
    </footer>
